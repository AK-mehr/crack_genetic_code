from tokenizerOHE_RNN4Layers import letter_to_index, letter_to_tensor, sequence_to_tensor, loadData, codon_to_tensor, \
    tensor_to_codon, index_to_tensor, updateANDsave_heatmap, codon_to_tensor_12bits, tensor3x4_to_codon
from tokenizerOHE_RNN4Layers import nucleotideLetters, aminoAcidLetters, nucleotideLetterList, \
...
class RNN(nn.Module):
    ...
    def __init__(self, 
        ...
        self.rnn1 = nn.RNN(input_features, hidden_features_layer1, num_layers, batch_first=True)
        self.rnn2 = nn.RNN(input_features, hidden_features_layer2, hidden_features_layer1, batch_first=True)
        self.rnn3 = nn.RNN(input_features, hidden_features_layer3, hidden_features_layer2, batch_first=True)
        self.rnn4 = nn.RNN(input_features, hidden_features_layer4, hidden_features_layer3, batch_first=True)
    ...
    def forward(self, input_tensor):
        ...
        #ho = rnn.init_hidden()
        # forward prop
        output, hupdated = self.rnn1(input_tensor, h0)
        output, hupdated = self.rnn2(input_tensor, h1)
        output, hupdated = self.rnn3(input_tensor, h2)
        output, hupdated = self.rnn4(input_tensor, h3)
...
network = RNN(N_nucleotides, n_hidden1, n_hidden2, n_hidden3, n_hidden4, num_layers, N_aminoAcids)
...
#plt.show()
#save figure:
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/RNN4hiddenlayers40ep256weights.svg")
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/RNN4hiddenlayers40ep256weights.pdf")
...
ThisFileName = "RNN4layers256_40epFreqTRue.txt"
scoresfile = open(filePATH+ThisFileName, 'w')
headerline = 'RNN 4 layers hidden size 256 adjusting for weights.\n'
