from tokenizerOHE_GRU4Layers import letter_to_index, letter_to_tensor, sequence_to_tensor, loadData, codon_to_tensor, \
    tensor_to_codon, index_to_tensor, updateANDsave_heatmap, codon_to_tensor_12bits, tensor3x4_to_codon
from tokenizerOHE_GRU4Layers import nucleotideLetters, aminoAcidLetters, nucleotideLetterList, \
...
network = GRU(N_nucleotides, n_hidden1, n_hidden2, n_hidden3, n_hidden4, num_layers, N_aminoAcids)
...
#plt.show()
#save figure:
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/GRU4hiddenlayers40ep256weights.svg")
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/GRU4hiddenlayers40ep256weights.pdf")
...
ThisFileName = "GRU4layers256_40epFreqTRue.txt"
scoresfile = open(filePATH+ThisFileName, 'w')
headerline = 'GRU 4 layers hidden size 256 adjusting for weights.\n'
