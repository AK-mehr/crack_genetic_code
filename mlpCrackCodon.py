from tokenizerOHE_MLP import letter_to_index, letter_to_tensor, sequence_to_tensor, loadData, codon_to_tensor, \
    tensor_to_codon, index_to_tensor, updateANDsave_heatmap
from tokenizerOHE_MLP import nucleotideLetters, aminoAcidLetters, nucleotideLetterList, \
...
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/MLP_40iter64bits1024weights.svg")
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/MLP_40iter64bits1024weights.pdf")
...
ThisFileName = "MLP_40iter64bits1024weights.txt"
scoresfile = open(filePATH+ThisFileName, 'w')
headerline = 'MLP OHE 64 bits Hidden Layer 1024 with 40 epochs with adjustment for classes weights.\n'
scoresfile.write(headerline) # write header line just once
headerline = 'epoch' + '\t' + 'train_loss' + '\t' + 'test_loss' + '\t' + 'train_accuracy' + '\t' + 'test_accuracy' + '\n'
