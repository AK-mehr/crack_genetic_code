from tokenizerOHE_GRU6Layers import letter_to_index, letter_to_tensor, sequence_to_tensor, loadData, codon_to_tensor, \
    tensor_to_codon, index_to_tensor, updateANDsave_heatmap, codon_to_tensor_12bits, tensor3x4_to_codon
from tokenizerOHE_GRU6Layers import nucleotideLetters, aminoAcidLetters, nucleotideLetterList, \
...
hidden_features_layer3 = 64
hidden_features_layer4 = 32  
hidden_features_layer5 = 16  
...
class GRU(nn.Module):
    def __init__(self, 
        ...
        self.gru1 = nn.GRU(input_features, hidden_features_layer1, num_layers, batch_first=True)
        self.gru2 = nn.GRU(input_features, hidden_features_layer2, hidden_features_layer1, batch_first=True)
        self.gru3 = nn.GRU(input_features, hidden_features_layer3, hidden_features_layer2, batch_first=True)
        self.gru4 = nn.GRU(input_features, hidden_features_layer4, hidden_features_layer3, batch_first=True)
        self.gru5 = nn.GRU(input_features, hidden_features_layer5, hidden_features_layer4, batch_first=True)
        self.gru6 = nn.GRU(input_features, hidden_features_layer6, hidden_features_layer5, batch_first=True)
    ...
    def forward(self, input_tensor):
        ...
        output, hupdated = self.gru1(input_tensor, h0)
        output, hupdated = self.gru2(input_tensor, h1)
        output, hupdated = self.gru3(input_tensor, h2)
        output, hupdated = self.gru4(input_tensor, h3)
        output, hupdated = self.gru5(input_tensor, h4)
        output, hupdated = self.gru6(input_tensor, h5)
...
network = GRU(N_nucleotides, n_hidden1, n_hidden2, n_hidden3, n_hidden4, n_hidden5, n_hidden6, num_layers, N_aminoAcids)
...
#plt.show()
#save figure:
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/GRU6hiddenlayers40ep256weights.svg")
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/GRU6hiddenlayers40ep256weights.pdf")
...
ThisFileName = "GRU6layers256_40epFreqTRue.txt"
scoresfile = open(filePATH+ThisFileName, 'w')
headerline = 'GRU 6 layers hidden size 256 adjusting for weights.\n'
