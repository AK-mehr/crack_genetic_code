from tokenizerOHE_LSTM import letter_to_index, letter_to_tensor, sequence_to_tensor, loadData, codon_to_tensor, \
    tensor_to_codon, index_to_tensor, updateANDsave_heatmap, codon_to_tensor_12bits, tensor3x4_to_codon
from tokenizerOHE_LSTM import nucleotideLetters, aminoAcidLetters, nucleotideLetterList, \
