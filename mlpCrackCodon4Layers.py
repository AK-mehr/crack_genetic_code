from tokenizerOHE_MLP4Layers import letter_to_index, letter_to_tensor, sequence_to_tensor, loadData, codon_to_tensor, \
    tensor_to_codon, index_to_tensor, updateANDsave_heatmap
from tokenizerOHE_MLP4Layers import nucleotideLetters, aminoAcidLetters, nucleotideLetterList, \
...
class MLP(nn.Sequential): # Multilayer Perceptron Network
    def __init__(self, input_features, 
        ...
        super().__init__(
            ...
            nn.Linear(hidden_features_layer4, output_features, bias=False),
...
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/MLP_40iter64bits1024weights4layers.svg")
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/MLP_40iter64bits1024weights4layers.pdf")
...
ThisFileName = "MLP_40iter64bits1024weights4Layers.txt"
scoresfile = open(filePATH+ThisFileName, 'w')
headerline = 'MLP OHE 64 bits Hidden Layer 1024 with 40 epochs with adjustment for classes weights.\n'
scoresfile.write(headerline) # write header line just once
headerline = 'epoch' + '\t' + 'train_loss' + '\t' + 'test_loss' + '\t' + 'train_accuracy' + '\t' + 'test_accuracy' + '\n'
