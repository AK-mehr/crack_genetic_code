from tokenizerOHE_RNN import letter_to_index, letter_to_tensor, sequence_to_tensor, loadData, codon_to_tensor, \
    tensor_to_codon, index_to_tensor, updateANDsave_heatmap, codon_to_tensor_12bits, tensor3x4_to_codon
from tokenizerOHE_RNN import nucleotideLetters, aminoAcidLetters, nucleotideLetterList, \
...
#plt.show()
#save figure:
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/RNN2hiddenlayers40ep256weights.svg")
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/RNN2hiddenlayers40ep256weights.pdf")
