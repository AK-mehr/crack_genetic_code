from tokenizerOHE_LSTM4Layers import letter_to_index, letter_to_tensor, sequence_to_tensor, loadData, codon_to_tensor, \
    tensor_to_codon, index_to_tensor, updateANDsave_heatmap, codon_to_tensor_12bits, tensor3x4_to_codon
from tokenizerOHE_LSTM4Layers import nucleotideLetters, aminoAcidLetters, nucleotideLetterList, \
...
class LSTM(nn.Module):
    def __init__(self, input_features, hidden_features_layer1, hidden_features_layer2, hidden_features_layer3, hidden_features_layer4, num_layers, num_of_classes):
        ...
        self.fc1 = nn.Linear(hidden_features_layer4, num_of_classes, bias=False)
...
network = LSTM(N_nucleotides, n_hidden1, n_hidden2, n_hidden3, n_hidden4, num_layers, N_aminoAcids)
