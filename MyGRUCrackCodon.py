from tokenizerOHE_GRU import letter_to_index, letter_to_tensor, sequence_to_tensor, loadData, codon_to_tensor, \
    tensor_to_codon, index_to_tensor, updateANDsave_heatmap, codon_to_tensor_12bits, tensor3x4_to_codon
from tokenizerOHE_GRU import nucleotideLetters, aminoAcidLetters, nucleotideLetterList, \
...
#plt.show()
#save figure:
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/GRU2hiddenlayers40ep256weights.svg")
plt.savefig(r"/content/deep-learning-project-cracking-the-genetic-code/FIGURES/GRU2hiddenlayers40ep256weights.pdf")
...
ThisFileName = "GRU2layers256_40epFreqTRue.txt"
scoresfile = open(filePATH+ThisFileName, 'w')
headerline = 'GRU 2 layers hidden size 256 adjusting for weights.\n'
